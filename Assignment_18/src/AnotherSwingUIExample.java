...
public class AnotherSwingUIExample extends JFrame {
	...
	public AnotherSwingUIExample() {
		setTitle("Another Swing UI Example");
		setSize(800, 600);
		...
		textArea = new JTextArea("Click me to go to the next page");
		...
		popupMenuItem.addActionListener(e -> JOptionPane.showMessageDialog(this, "Popup menu item selected"));
		...
		dialog.add(new JLabel("This is a dialog"), BorderLayout.CENTER);
	...
	private void updateTextArea() {
		...
		textArea.setText("You selected: " + selectedItem);
	}
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			new AnotherSwingUIExample().setVisible(true);
		});
	}
}
